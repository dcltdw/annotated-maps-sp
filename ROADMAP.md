...
- **Service mesh, multi-region, Karpenter** — capability theater at this scale. The [production-lenses document](docs/architecture/2026-06-09-production-lenses.md) records where each would earn its place as the system grows.
